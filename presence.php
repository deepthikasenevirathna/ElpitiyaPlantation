...
<style>
/* .........Map............... */
.mapboxgl-popup-content div .col-9.align-middle {
    padding-left: 12%;
}
h4.popup_title {
    font-weight: 900;
...
.heading {
    background: #fff;
    border-bottom: 1px solid #87bb40;
    min-height: 60px;
    line-height: 60px;
    padding: 0 10px;
    color: #87bb40;
...
.setHTML(
`<h4 class="popup_title">${currentFeature.properties.address}</h4><h4>${currentFeature.properties.city}</h4>`
)
.addTo(map);
}
</script>
